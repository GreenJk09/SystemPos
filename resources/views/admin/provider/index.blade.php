...
<div class="page-header">
  ...
  <nav class="breadcrumb-one" aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page"><span>Proveedores</span></li>
    </ol>
  </nav>
</div>
      ...
      <div class="widget-header">
        <div class="row">
          ...
          <div class="col-xl-4 text-right">
            <a class="btn btn-primary mb-2 mr-2" style="margin-top:5px" href="{{route('providers.create')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
